...
const PricingCalculator = () => {
  ...
  const [hasStage, setHasStage] = useState<string>("no");
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12 bg-muted p-8 rounded-xl shadow-sm reveal">
              ...
              <div className="space-y-6">
                ...
                {hasStage === "yes" && (
                  <div className="grid md:grid-cols-2 gap-6 reveal animation-delay-500">
            ...
            <div className="mb-12 bg-muted p-8 rounded-xl shadow-sm reveal">
              ...
              <div className="space-y-6">
                ...
                {borderType !== "none" && (
                  <div className="form-group reveal animation-delay-900">
